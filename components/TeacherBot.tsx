...
export const TeacherBot: React.FC<TeacherBotProps> = ({ context }) => {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-4 right-4 z-50 flex flex-col items-end pointer-events-none">
      <div className="pointer-events-auto">
        {isOpen && (
            <div className="mb-4 w-[calc(100vw-2rem)] md:w-80 bg-white rounded-2xl shadow-2xl border-2 border-blue-200 overflow-hidden mx-auto md:mx-0">
            ...
            <div className="p-4 bg-gray-50 max-h-64 md:max-h-96 overflow-y-auto">
                {!answer && !loading && (
        ...
        <button 
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white p-3 md:p-4 rounded-full shadow-lg transition-transform hover:scale-105 flex items-center gap-2 float-right"
        >
            <MessageCircle size={24} />
            {!isOpen && <span className="font-bold hidden md:inline">提问</span>}
        </button>
      </div>
    </div>
  );
